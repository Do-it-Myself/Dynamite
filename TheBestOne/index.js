...
var Bot = /** @class */ (function () {
    ...
    Bot.prototype.getTertiaryTransition = function (key) {
        var _a;
        return (_a = this.tertiaryTransitions.get(JSON.stringify(key))) !== null && _a !== void 0 ? _a : 0;
    };
    ...
    Bot.prototype.incrementTertiaryTransition = function (key) {
    ...
    Bot.prototype.setTertiaryTransition = function (key, value) {
    ...
    Bot.prototype.update = function (game) {
        ...
        var secondaryDecayFactor = 0.95;
        var tertiaryDecayFactor = 0.95;
        ...
        var fourRoundsAgo = (_c = game.rounds[game.rounds.length - 4]) !== null && _c !== void 0 ? _c : null;
        // one prev state
        ...
        this.transitions.forEach(function (v, k) {
            _this.transitions.set(k, v * secondaryDecayFactor);
        });
        // three prev states
        this.incrementTertiaryTransition([fourRoundsAgo, threeRoundsAgo, twoRoundsAgo, oneRoundAgo.p2]);
        this.transitions.forEach(function (v, k) {
            _this.transitions.set(k, v * tertiaryDecayFactor);
        });
    ...
    Bot.prototype.predictOpponentsMove = function (game) {
        ...
        var tertiaryOccurenceFactor = 10;
        for (var _i = 0, possibleMoves_4 = possibleMoves; _i < possibleMoves_4.length; _i++) {
            ...
            var tertiaryOccurences = this.getTertiaryTransition([threeRoundsAgo, twoRoundsAgo, oneRoundAgo, move]);
